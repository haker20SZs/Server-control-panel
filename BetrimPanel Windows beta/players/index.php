	...
	<div class="project-players white--bg border-radius-big-sm" data-v-a62d9756="">
		<div class="project-players__head" data-v-a62d9756="">
	       ...
	       <center>
	       	    ...
	       	    <a href="/panel.php?key=<?php echo($_GET['key']); ?>" rel="nofollow" class="project-players__tab transparent-grey2--text" data-v-a62d9756="">Главная страница</a>
	       	    <a href="./?key=<?php echo($_GET['key']); ?>" rel="nofollow" class="project-players__tab transparent-grey2--text project-players__tab--active" data-v-a62d9756="">Заходы</a>
