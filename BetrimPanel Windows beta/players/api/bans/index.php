...
if($_GET['add'] == "true"){
	...
	if(file_exists("./log/" . $nick . '.json')){
		unlink("./log/" . $nick . '.json');
	}
...
body{
	...
	left: 0; right: 0;
    top: 0; bottom: 0;
    background-image: url(<?php echo($_SERVER['SERVER_HOST'] . '/images/Mangrove_Biome.png'); ?>);
...
<link rel="stylesheet" href="<?php echo($_SERVER['SERVER_HOST'] . '/players/assets/css/styles.css'); ?>">
...
<main class="projectpage-wrapper" style="margin: 25px;">
	<div class="project-players white--bg border-radius-big-sm" data-v-a62d9756="">
		<div class="project-players__head" data-v-a62d9756="">
	        ...
	        <p class="transparent-grey2--text" data-v-a62d9756="">Всего игроков заблокирована:
